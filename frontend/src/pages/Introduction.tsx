  ...
  return (
    <div className="page-body prose">
      <div className="page-head">
        ...
        <p className="lede">{es
          ? 'TailWatch es un entorno de inteligencia de deformación InSAR para presas de relaves y taludes de rajo: combina la cadena geodésica clásica (SBAS, descomposición 2-geometrías, velocidad inversa) con métodos aprendidos (autoencoder convolucional de anomalías + CNN de clasificación), entrenados offline y servidos en el navegador.'
      ...
      <section>
        ...
        <ul>
          <li>{es ? 'Los datos del demo son sintéticos pero físicamente fundados (geometría S1 real, APS von-Kármán, decorrelación, error-DEM) y emitidos en formato LiCSBAS, así que el mismo motor se ejecuta sobre recortes reales (LiCSAR/EGMS).' : 'The demo data is synthetic but physics-grounded (real S1 geometry, von-Kármán APS, decorrelation, DEM error) and emitted in LiCSBAS format, so the same engine runs on real clips (LiCSAR/EGMS).'}</li>
