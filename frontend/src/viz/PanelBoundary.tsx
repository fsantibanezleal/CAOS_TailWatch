      ...
      return (
        <div className="tw-note" style={{ padding: '1rem', color: 'var(--color-fg-faint)' }}>
          ...
          <p className="tw-hint" style={{ marginTop: '0.4rem' }}>
            {es
              ? 'No se pudo computar esta vista sobre el dato actual (p. ej. una escena sin la geometría o el formato que la herramienta requiere). Elige otra pestaña o fuente.'
