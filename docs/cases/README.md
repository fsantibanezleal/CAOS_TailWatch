...
* Roadmap: a MapLibre/deck.gl geo-basemap and a real digitized published velocity series as a second benchmark
  target, plus visual and rigour polish, documented in the Experiments page.
