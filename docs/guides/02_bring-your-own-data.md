...
and onnxruntime-web runs the CNN per picked pixel (the AE anomaly map comes precomputed from the offline lane). The
scenes are synthetic; this is didactic + decision-support, not a certified alarm (see `docs/cases/README.md`).
